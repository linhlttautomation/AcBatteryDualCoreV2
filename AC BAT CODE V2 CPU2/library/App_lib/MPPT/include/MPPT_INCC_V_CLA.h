#ifndef MPPT_INCC_V_CLA_H_
#define MPPT_INCC_V_CLA_H_
...
typedef MPPT_INCC_V_CLA *mppt_incc_v_handle;

//*********** Function Declarations *******//
void MPPT_INCC_V_CLA_FUNC(MPPT_INCC_V_CLA *v);

//*********** Structure Init Macro *******//
#define MPPT_INCC_V_CLA_init(v)	\
	v.Ipv=0;					\
	v.Vpv=0;					\
	v.IpvH=(1.65);				\
	v.IpvL=0;					\
...
//*********** Macro Definition ***********//
#define MPPT_INCC_V_CLA_MACRO(v)																	\
if (v.mppt_enable==1)																				\
{	/*MPPT mode enable*/																			\
	if (v.mppt_first == 1)																			\
	{																								\
...
//*********** Macro Definition ***********//
#define MPPT_INCC_V_CLA_MACRO_V2(v)                                                                 \
if (v.mppt_enable==1)                                                                               \
{   /*MPPT mode enable*/                                                                            \
    if (v.mppt_first == 1)                                                                          \
    {                                                                                               \
    ...
    {                                                                                               \
        ...
        {                                                                                           \
            ...
            {                                                                                       \
                if ( v.DeltaI > 0 )                 /* climbing towards MPP */                      \
                {v.VmppOut=v.VmppOut+v.Stepsize;}       /* Increment Vref */                        \
                else                                                                                \
                {v.VmppOut=v.VmppOut-v.Stepsize;}       /* Decrement Vref */                        \
            }                                                                                       \
        }                                                                                           \
        else                                                                                        \
        {                                                                                           \
            ...
            {                                                                                       \
                if (v.IncCond > (-v.Cond))          /* left of MPP */                               \
                {                                                                                   \
                v.VmppOut=v.VmppOut+v.Stepsize;         /* change Vref */                           \
                }                                                                                   \
                else                                /* Right of MPP */                              \
                {                                                                                   \
                v.VmppOut=v.VmppOut-v.Stepsize;         /* change Vref */                           \
