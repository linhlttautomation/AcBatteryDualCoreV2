#ifndef MPPT_INCC_D_CLA_H_
#define MPPT_INCC_D_CLA_H_
...
typedef MPPT_INCC_D_CLA *mppt_incc_d_handle;

//*********** Function Declarations *******//
void MPPT_INCC_D_CLA_FUNC(MPPT_INCC_D_CLA *v);

//*********** Structure Init Macro *******//
#define MPPT_INCC_D_CLA_init(v)	\
	v.Ipv=0;					\
	v.Vpv=0;					\
	v.IpvH=(1.65);				\
	v.IpvL=0;					\
...
//*********** Macro Definition ***********//
#define MPPT_INCC_D_CLA_MACRO(v)																	\
if (v.mppt_enable==1)																				\
{	/*MPPT mode enable*/																			\
	if (v.mppt_first == 1)																			\
	{																								\
	...
	{																								\
		...
		{																							\
			...
			{																						\
				...
				{v.DutyOut=v.DutyOut+v.Stepsize;}		/* Increment Vref */						\
				else																				\
				{v.DutyOut=v.DutyOut-v.Stepsize;} 		/* Decrement Vref */						\
			}																						\
		}																							\
    	else  																						\
		{																							\
			...
			{																						\
				...
				{																					\
				v.DutyOut=v.DutyOut+v.Stepsize;			/* change Vref */						    \
				}																					\
				else								/* Right of MPP */								\
				{																					\
				v.DutyOut=v.DutyOut-v.Stepsize;			/* change Vref */							\
