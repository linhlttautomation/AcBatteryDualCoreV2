...
#define CNTL_PI_CLA_MACRO(v)							\
    ...
    v.Err = v.Ref - v.Fbk;                              \
	/* proportional term */ 							\
	v.up = (v.Err*v.Kp*(v.IN_MAX/v.OUT_MAX));	                                    \
	/* integral term */ 								                            \
	v.ui = (v.Out == v.v1)?((v.Ki*v.Ts*(v.IN_MAX/v.OUT_MAX)* v.Err)+ v.i1) : v.i1;	\
	v.i1 = v.ui;										\
	/* control output */ 								\
	v.v1 = (v.up + v.ui);								\
